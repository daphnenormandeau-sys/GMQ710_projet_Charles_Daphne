...
def generateImage_firezones(transformed_burnt_polygons_list, metadata_refl, starting_crs, final_crs, filename, date_of_report):
    ...
    ax.add_geometries([poly_bounds], crs = ccrs.epsg(final_crs[-5:]), facecolor='none', edgecolor='red', linewidth=2.5)
    ...
    #                    scale=0.5, # Desired height in inches
    #                    rotation={"crs": final_crs, "reference": "center"})
